...
`;var Oe={title:"Ask us anything",open:"Open the support chat",close:"Close the support chat",placeholder:"Type your question",send:"Send",inputLabel:"Your question",attach:"Attach a file",removeFile:"Remove {name}",dictate:"Dictate your question",stopDictating:"Stop dictating",call:"Talk to us",endCall:"End the call",calling:"Connecting",callStarted:"Call started",callEnded:"Call ended",working:"Checking {name}",helpful:"This helped",notHelpful:"This did not help",thanks:"Thanks, that helps us improve.",copy:"Copy this answer",copied:"Copied",deleteConversation:"Delete this conversation",deleteConfirm:"Delete this conversation? It cannot be brought back.",offline:"Could not reach the assistant. Check your connection.",rateLimited:"Too many messages just now. Give it a moment.",unavailable:"The assistant is unavailable ({status}).",submit:"Send",submitted:"Thanks, sending that now.",dismiss:"Dismiss"};function He(e){if(!e)return Oe;let t={...Oe};for(let[n,o]of Object.entries(e))typeof o=="string"&&o.trim().length>0&&(t[n]=o);return t}function ue(e,t){return e.replace(/\{(\w+)\}/g,(n,o)=>o in t?String(t[o]):n)}var Tt=["recourse_q","rc_q"];function Lt(e={}){let t=e.params??Tt,n;try{n=new URL(e.href??window.location.href)}catch{return null}let o=null;for(let l of t){let s=n.searchParams.get(l);if(s&&s.trim()){o=s.trim().slice(0,1e3);break}}if(o===null)return null;if(e.strip!==!1){for(let l of t)n.searchParams.delete(l);try{window.history.replaceState(window.history.state,"",n.toString())}catch{}}return o}function Fe(e,t={}){let n=Lt(t);return n===null?null:(e.open(),e.ask(n),n)}function Ue(e){return`recourse:transcript:${e}`}function Pe(e){return`recourse:invite:${e}`}var F={chat:"M12 3c5 0 9 3.4 9 7.6 0 4.2-4 7.6-9 7.6-.9 0-1.8-.1-2.6-.3L5 20l1-3.3C4.2 15.3 3 13.1 3 10.6 3 6.4 7 3 12 3z",close:"M6 6l12 12M18 6L6 18",send:"M4 12l16-8-6 8 6 8z",clip:"M21 11.5l-8.6 8.6a5 5 0 01-7-7l8.5-8.6a3.3 3.3 0 014.7 4.7l-8.5 8.5a1.7 1.7 0 01-2.4-2.4l7.9-7.8",mic:"M12 3a3 3 0 013 3v6a3 3 0 01-6 0V6a3 3 0 013-3zM5 11a7 7 0 0014 0M12 18v3",phone:"M6.6 10.8a15.1 15.1 0 006.6 6.6l2.2-2.2a1 1 0 011-.24 11.4 11.4 0 003.6.57 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.4 11.4 0 00.57 3.6 1 1 0 01-.25 1z",hangUp:"M3 10.5c5-4 13-4 18 0v3.2a1 1 0 01-1.3.95l-3.4-1a1 1 0 01-.7-1V10a12 12 0 00-7.2 0v2.6a1 1 0 01-.7 1l-3.4 1A1 1 0 013 13.7z"},Rt=["image/png","image/jpeg","image/webp","image/gif","application/pdf","text/plain","text/markdown","text/csv","application/vnd.openxmlformats-officedocument.wordprocessingml.document"];function We(e){if(!e.endpoint)throw new Error("recourse: an `endpoint` is required");let t=He(e.strings),n=!!e.target,o=document.createElement("div");o.setAttribute("data-recourse",""),n&&o.setAttribute("data-inline","true"),o.style.cssText=n?"display:block;width:100%;height:100%":"";let l=o.attachShadow({mode:"open"}),s=document.createElement("style");s.textContent=Ie,l.appendChild(s),e.accent&&o.style.setProperty("--rc-accent",e.accent),Mt(o,e.theme??"auto");let c=e.position==="bottom-left"?"pos-left":"pos-right",a={messages:e.persist===!1?[]:Nt(e.endpoint),busy:!1,controller:null,conversationId:`c_${Date.now().toString(36)}${Math.random().toString(36).slice(2,10)}`,suggestions:e.suggestions??[],staged:[]},p={...e.actions},g=[],u=new Map;function v(r,i){for(let d of u.get(r)??[])try{d(i)}catch(f){console.error(`[recourse] listener for "${r}" threw`,f)}}let y=document.createElement("button");y.className=`launcher ${c}`,y.type="button",y.setAttribute("aria-label",t.open),y.setAttribute("aria-expanded","false"),y.appendChild(N(F.chat,!0));let x=document.createElement("div");x.className=`panel ${c}`,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","false"),x.setAttribute("aria-label",e.title??t.title),x.dataset.open=String(n||e.open===!0);let m=document.createElement("div");m.className="header";let k=document.createElement("div");k.className="grow";let L=document.createElement("h2");if(L.textContent=e.title??t.title,k.appendChild(L),e.subtitle){let r=document.createElement("p");r.textContent=e.subtitle,k.appendChild(r)}m.appendChild(k);let A=document.createElement("button");A.className="icon-button",A.type="button",A.setAttribute("aria-label",t.deleteConversation),A.appendChild(N("M3 6h18v2H3V6zm2 3h14l-1 12H6L5 9zm5 2v8h2v-8h-2zm4 0v8h2v-8h-2zM9 3h6v2H9V3z",!1)),e.allowDelete&&m.appendChild(A);let _=document.createElement("button");_.className="icon-button",_.type="button",_.setAttribute("aria-label",t.close),_.appendChild(N(F.close,!1)),n||m.appendChild(_);let S=document.createElement("div");S.className="log",S.setAttribute("role","log"),S.setAttribute("aria-live","polite"),S.setAttribute("aria-relevant","additions text"),S.setAttribute("aria-live","polite"),S.setAttribute("aria-relevant","additions text");let X=document.createElement("div");X.className="suggestions";let z=document.createElement("div");z.className="error",z.hidden=!0,z.setAttribute("role","alert");let G=document.createElement("form");G.className="composer";let w=document.createElement("textarea");w.setAttribute("dir","auto"),w.rows=1,w.placeholder=t.placeholder,w.setAttribute("aria-label",t.inputLabel);let U=document.createElement("button");U.type="submit",U.setAttribute("aria-label",t.send),U.appendChild(N(F.send,!0));let D=e.attachments?{maxBytes:(typeof e.attachments=="object"?e.attachments.maxBytes:void 0)??10*1024*1024,maxCount:(typeof e.attachments=="object"?e.attachments.maxCount:void 0)??4,accept:(typeof e.attachments=="object"?e.attachments.accept:void 0)??Rt}:null,V=document.createElement("div");V.className="tray",V.hidden=!0;let I=document.createElement("input");I.type="file",I.multiple=!0,I.hidden=!0,I.tabIndex=-1;let q=document.createElement("button");q.type="button",q.className="attach",q.setAttribute("aria-label",t.attach),q.appendChild(N(F.clip,!1));let pe=e.dictation?typeof e.dictation=="object"?e.dictation:{}:null,W=document.createElement("button");W.type="button",W.className="mic",W.setAttribute("aria-label",t.dictate),W.appendChild(N(F.mic,!1));let H=null;D&&(I.accept=D.accept.join(",")),pe&&(H=Ae({...pe,onStateChange:r=>{W.dataset.recording=String(r),W.setAttribute("aria-label",r?t.stopDictating:t.dictate),r||(w.dataset.interim="")},onInterim:r=>{w.value=`${w.dataset.beforeDictation??""}${r}`},onFinal:r=>{let i=w.dataset.beforeDictation??"",d=i&&!i.endsWith(" ")?`${i} ${r}`:`${i}${r}`;w.value=d,w.dataset.beforeDictation=d},onError:r=>B(r)}),H&&(W.addEventListener("click",()=>{H&&(H.recording||(w.dataset.beforeDictation=w.value),H.toggle(),w.focus())}),w.addEventListener("keydown",r=>{r.key==="Escape"&&H?.recording&&(r.preventDefault(),w.value=w.dataset.beforeDictation??"",H.cancel())})));let me=typeof e.call=="string"?e.call:e.call?e.call.endpoint:null,fe=typeof e.call=="object"?e.call.load:void 0,je=typeof e.call=="object"?e.call.transport:void 0,P=document.createElement("button");P.type="button",P.className="call",P.setAttribute("aria-label",t.call),P.appendChild(N(F.phone,!1));let te=null;if(me){let r={endpoint:me,conversationId:()=>a.conversationId,onStateChange:i=>$e(i),onTranscript:({role:i,text:d})=>{J({role:i==="visitor"?"user":"assistant",content:d})},onError:i=>B(i)};te=je==="hosted"?De(r):Te({...r,...fe?{load:fe}:{}}),P.addEventListener("click",()=>{te?.toggle()})}function $e(r){P.dataset.state=r;let i=r==="live"||r==="connecting";P.setAttribute("aria-label",i?t.endCall:t.call),P.replaceChildren(N(i?F.hangUp:F.phone,!1)),r==="live"&&Z(t.callStarted),r==="ended"&&Z(t.callEnded)}let _e=H?[W]:[],Ve=te?[P]:[];G.append(...D?[q]:[],w,..._e,...Ve,U),x.append(m,S,X,z,V,G),D&&x.appendChild(I),n?l.append(x):l.append(y,x),(e.target??document.body).appendChild(o),D&&(q.addEventListener("click",()=>I.click()),I.addEventListener("change",()=>{I.files&&ne(I.files),I.value=""}),x.addEventListener("dragover",r=>{r.dataTransfer?.types.includes("Files")&&(r.preventDefault(),x.dataset.dropping="true")}),x.addEventListener("dragleave",()=>{delete x.dataset.dropping}),x.addEventListener("drop",r=>{r.dataTransfer?.files.length&&(r.preventDefault(),delete x.dataset.dropping,ne(r.dataTransfer.files))}),w.addEventListener("paste",r=>{let i=Array.from(r.clipboardData?.files??[]);i.length!==0&&(r.preventDefault(),ne(i))}));function K(r){v(r?"open":"close",{}),r&&l.querySelector(".invite")?.remove(),x.dataset.open=String(r),y.setAttribute("aria-expanded",String(r)),y.setAttribute("aria-label",r?t.close:t.open),r?w.focus():y.focus()}function B(r){z.textContent=r,z.hidden=!1}async function ne(r){if(D){z.hidden=!0;for(let i of Array.from(r)){if(a.staged.length>=D.maxCount){B(`You can attach ${D.maxCount} files at a time.`);break}let d=(i.type||"").split(";")[0]?.trim().toLowerCase()??"";if(!D.accept.includes(d)){B(`${i.name} is not a file type we can read.`);continue}if(i.size>D.maxBytes){B(`${i.name} is larger than ${Math.round(D.maxBytes/1024/1024)}MB.`);continue}let f;try{f=await Dt(i)}catch{B(`${i.name} could not be read.`);continue}a.staged.push({name:i.name,mimeType:d,dataUrl:f,bytes:i.size})}re()}}function re(){V.replaceChildren(),V.hidden=a.staged.length===0;for(let[r,i]of a.staged.entries()){let d=document.createElement("span");d.className="chip";let f=document.createElement("span");f.textContent=i.name,d.appendChild(f);let h=document.createElement("button");h.type="button",h.setAttribute("aria-label",ue(t.removeFile,{name:i.name})),h.appendChild(N(F.close,!1)),h.addEventListener("click",()=>{a.staged.splice(r,1),re(),w.focus()}),d.appendChild(h),V.appendChild(d)}}function j(){S.scrollTop=S.scrollHeight}function qe(r,i){let d=new Set;for(let R of i.matchAll(/\[(\d{1,2})\]/g))d.add(Number.parseInt(R[1],10)-1);let f=d.size>0?r.filter((R,E)=>d.has(E)):r,h=new Set,b=[];for(let R of f){let E=`${R.url??""}|${R.title}|${R.section??""}`;h.has(E)||(h.add(E),b.push(R))}return b}function ge(r,i){if(i.length===0)return;let d=document.createElement("div");d.className="sources";for(let f of i.slice(0,4)){let h=f.section?`${f.title} \xB7 ${f.section}`:f.title,b=document.createElement(f.url?"a":"span");b.textContent=h,f.url&&b instanceof HTMLAnchorElement&&(b.href=f.url,b.target="_blank",b.rel="noopener noreferrer"),d.appendChild(b)}r.appendChild(d)}function J(r){let i=document.createElement("div");i.className="msg",i.dataset.role=r.role;let d=document.createElement("div");return d.className="bubble",d.setAttribute("dir","auto"),r.role==="user"?d.textContent=r.content:d.appendChild(Y(r.content)),r.role==="user"&&!r.content&&r.attachments?.length?d.remove():i.appendChild(d),r.attachments?.length&&et(i,r.attachments),r.sources&&ge(i,r.sources),S.appendChild(i),j(),{bubble:d,wrapper:i}}function oe(){if(X.replaceChildren(),a.suggestions.length!==0)for(let r of a.suggestions.slice(0,4)){let i=document.createElement("button");i.type="button",i.textContent=r,i.addEventListener("click",()=>{Q(r)}),X.appendChild(i)}}function he(){S.replaceChildren(),e.greeting&&J({role:"assistant",content:e.greeting});for(let r of a.messages)J(r);oe()}function Ke(r){if(e.copy===!1||typeof navigator>"u"||!navigator.clipboard?.writeText)return;let i=document.createElement("button");return i.type="button",i.className="icon-button",i.setAttribute("aria-label",t.copy),i.appendChild(N("M16 1H4a2 2 0 00-2 2v14h2V3h12V1zm3 4H8a2 2 0 00-2 2v14a2 2 0 002 2h11a2 2 0 002-2V7a2 2 0 00-2-2zm0 16H8V7h11v14z",!0)),i.addEventListener("click",()=>{navigator.clipboard.writeText(r).then(()=>{i.setAttribute("aria-label",t.copied),i.setAttribute("data-copied","true"),setTimeout(()=>{i.setAttribute("aria-label",t.copy),i.removeAttribute("data-copied")},1600)}).catch(()=>{})}),i}function be(){a.messages=[],a.suggestions=e.suggestions??[],a.conversationId=`c_${Date.now().toString(36)}${Math.random().toString(36).slice(2,10)}`,ze(e.endpoint,[],e.persist!==!1),he()}async function ve(){let r=a.conversationId;be();try{await fetch(e.endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({deleteConversation:r})})}catch{}}function Ge(r,i,d=""){let f=Ke(d);if(e.feedback===!1){if(!f)return;let b=document.createElement("div");b.className="feedback",b.appendChild(f),r.appendChild(b);return}let h=document.createElement("div");h.className="feedback";for(let[b,R,E]of[["positive",t.helpful,"M7 11v9H3v-9h4zm3 9V11l4-8a2 2 0 013 2l-1 5h5a2 2 0 012 2l-2 7a2 2 0 01-2 2h-9z"],["negative",t.notHelpful,"M17 13V4h4v9h-4zm-3-9v9l-4 8a2 2 0 01-3-2l1-5H3a2 2 0 01-2-2l2-7a2 2 0 012-2h9z"]]){let O=document.createElement("button");O.type="button",O.className="icon-button",O.setAttribute("aria-label",R),O.appendChild(N(E,!0)),O.addEventListener("click",()=>{O.setAttribute("aria-pressed","true"),h.querySelectorAll("button").forEach($=>{$!==O&&$.removeAttribute("aria-pressed")}),Je(i,b)}),h.appendChild(O)}f&&h.appendChild(f),r.appendChild(h)}async function Je(r,i){try{await fetch(e.endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({feedback:{conversationId:a.conversationId,messageIndex:r,value:i}})})}catch{}}async function Q(r){let i=r.trim();if(!i&&a.staged.length===0||a.busy)return;z.hidden=!0,a.busy=!0,U.disabled=!0,H?.recording&&H.cancel(),w.dataset.beforeDictation="";let d=a.staged;a.staged=[],re();let f={role:"user",content:i};d.length>0&&(f.attachments=d),a.messages.push(f),J(f),v("message",{text:i}),a.suggestions=[],oe(),a.controller=new AbortController,await ie(void 0,d),a.busy=!1,U.disabled=!1,a.controller=null,j(),w.focus()}async function ie(r,i){let{bubble:d,wrapper:f}=J({role:"assistant",content:""});S.setAttribute("aria-busy","true");let h=document.createElement("span");h.className="typing",h.append(document.createElement("i"),document.createElement("i"),document.createElement("i")),d.appendChild(h);let b=null,R=T=>{if(!E.content){if(!T){b?.remove(),b=null,d.contains(h)||d.appendChild(h);return}h.remove(),b??(b=document.createElement("div")),b.className="working",b.textContent=ue(t.working,{name:T}),d.contains(b)||d.appendChild(b),j()}},E={role:"assistant",content:""},O=[],$=[];if(await Se(e.endpoint,{messages:a.messages,conversationId:a.conversationId,userId:e.userId,userHash:e.userHash,contact:e.contact,actionResults:r,...i&&i.length>0?{attachments:i}:{}},{onSources:T=>{O=T},onDelta:T=>{h.remove(),b?.remove(),b=null,E.content+=T,d.replaceChildren(Y(E.content)),j()},onError:T=>{h.remove(),b?.remove(),b=null,B(T),v("error",{message:T})},onFrame:T=>Xe(T,$,R)},a.controller?.signal,t).finally(()=>{h.remove(),S.setAttribute("aria-busy","false")}),$.length>0&&!r){f.remove();let T=$.find(se=>se.payload?.form);if(T){ae={name:T.name,input:T.input};let se=Ce(T.payload?.form,xe),ee=document.createElement("div");ee.className="msg",ee.dataset.role="assistant",ee.appendChild(se),S.appendChild(ee),j();return}let nt=await Ze($);await ie(nt);return}E.content.trim()?(E.sources=qe(O,E.content),a.messages.push(E),ge(f,E.sources),Ge(f,a.messages.length-1,E.content),ze(e.endpoint,a.messages,e.persist!==!1),v("response",{text:E.content,sources:E.sources})):f.remove(),oe()}function Ye(r){return r.replace(/[_-]+/g," ").trim()}function Xe(r,i,d=()=>{}){if(r.type==="client-action")i.push({id:r.id,name:r.name,input:r.input,payload:r.payload});else if(r.type==="suggestions")a.suggestions=r.items;else if(r.type==="action")v("action",{name:r.name,status:r.status}),d(r.status==="running"?r.summary??Ye(r.name):null);else if(r.type==="captured")v("captured",{kind:r.kind,name:r.name,values:r.values});else if(r.type==="notice")Z(r.message);else if(r.type==="handoff")v("handoff",{ticketId:r.ticketId,message:r.message}),Z(r.message);else if(r.type==="ui"){let f=Ee({kind:r.kind,id:r.id,data:r.data},xe);if(f){let h=r.id?[...S.children].find(R=>R.dataset?.uiId===r.id):void 0,b=document.createElement("div");b.className="msg",b.dataset.role="assistant",r.id&&(b.dataset.uiId=r.id),b.appendChild(f),h?h.replaceWith(b):(S.appendChild(b),j())}}}let xe={submit:r=>{Q(r)},respond:r=>{Qe(r)},run:async(r,i)=>{let d=p[r];if(!d)throw new Error("That is not available here");return d(i)}},ae=null;async function Qe(r){let i=ae;ae=null,!(!i||a.busy)&&(a.busy=!0,U.disabled=!0,a.controller=new AbortController,await ie([{name:i.name,input:i.input,output:r}]),a.busy=!1,U.disabled=!1,a.controller=null)}async function Ze(r){return Promise.all(r.map(async i=>{let d=p[i.name];if(!d)return{name:i.name,input:i.input,output:{error:"no handler registered on this page"}};try{return{name:i.name,input:i.input,output:await d(i.input)}}catch(f){return{name:i.name,input:i.input,output:{error:f instanceof Error?f.message:String(f)}}}}))}function et(r,i){let d=document.createElement("div");d.className="attached";for(let f of i){if(f.mimeType.startsWith("image/")){let b=document.createElement("img");b.src=f.dataUrl,b.alt=f.name,d.appendChild(b);continue}let h=document.createElement("span");h.className="chip",h.textContent=f.name,d.appendChild(h)}r.appendChild(d)}function Z(r){let i=document.createElement("div");i.className="notice",i.textContent=r,S.appendChild(i),j()}function tt(){if(n||!e.invite||x.dataset.open==="true")return;try{if(sessionStorage.getItem(Pe(e.endpoint)))return}catch{}let r=document.createElement("div");r.className=`invite ${c}`,r.setAttribute("role","button"),r.tabIndex=0,r.appendChild(document.createTextNode(e.invite));let i=document.createElement("button");i.type="button",i.className="invite-dismiss",i.setAttribute("aria-label",t.dismiss),i.appendChild(N(F.close,!1));let d=()=>{r.remove();try{sessionStorage.setItem(Pe(e.endpoint),"1")}catch{}};i.addEventListener("click",h=>{h.stopPropagation(),d()});let f=()=>{d(),K(!0)};r.addEventListener("click",f),r.addEventListener("keydown",h=>{(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),f())}),r.appendChild(i),l.appendChild(r)}if(e.invite&&!n){let r=e.inviteDelay??4e3,i=setTimeout(tt,r);g.push(i)}y.addEventListener("click",()=>K(x.dataset.open!=="true")),_.addEventListener("click",()=>K(!1)),A.addEventListener("click",()=>{typeof window.confirm=="function"&&!window.confirm(t.deleteConfirm)||ve()}),G.addEventListener("submit",r=>{r.preventDefault();let i=w.value;w.value="",w.style.height="auto",Q(i)}),w.addEventListener("input",()=>{w.style.height="auto",w.style.height=`${w.scrollHeight}px`}),w.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),G.requestSubmit())}),l.addEventListener("keydown",r=>{r.key==="Escape"&&!n&&K(!1)}),he();let ye={open:()=>K(!0),close:()=>K(!1),ask:Q,on(r,i){let d=u.get(r)??new Set;return d.add(i),u.set(r,d),()=>d.delete(i)},handle(r,i){p[r]=i},clear(){be()},forget:()=>ve(),destroy(){a.controller?.abort();for(let r of g)clearTimeout(r);o.remove()},element:o};return e.deepLink!==!1&&Fe(ye),ye}function Mt(e,t){if(t!=="auto"){e.setAttribute("data-theme",t);return}let n=window.matchMedia("(prefers-color-scheme: dark)"),o=()=>e.setAttribute("data-theme",n.matches?"dark":"light");o(),n.addEventListener("change",o)}function N(e,t){let n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("aria-hidden","true"),n.setAttribute("fill",t?"currentColor":"none"),n.setAttribute("stroke",t?"none":"currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round");let o=document.createElementNS("http://www.w3.org/2000/svg","path");return o.setAttribute("d",e),n.appendChild(o),n}function Nt(e){try{let t=sessionStorage.getItem(Ue(e));return t?JSON.parse(t):[]}catch{return[]}}function ze(e,t,n){if(n)try{sessionStorage.setItem(Ue(e),JSON.stringify(t.slice(-20)))}catch{}}function Dt(e){return new Promise((t,n)=>{let o=new FileReader;o.onload=()=>t(String(o.result)),o.onerror=()=>n(new Error("unreadable")),o.readAsDataURL(e)})}function It(){let t=document.currentScript?.dataset??{},n=t.endpoint??window.recourseConfig?.endpoint;if(!n)return console.warn("[recourse] no data-endpoint on the script tag, widget not mounted"),null;let o=t.target?document.querySelector(t.target):null;return{endpoint:n,userId:t.userId,userHash:t.userHash,feedback:t.feedback!=="false",invite:t.invite,inviteDelay:t.inviteDelay?Number(t.inviteDelay):void 0,title:t.title,subtitle:t.subtitle,greeting:t.greeting,accent:t.accent,suggestions:t.suggestions?.split("|").map(l=>l.trim()).filter(Boolean),position:t.position==="bottom-left"?"bottom-left":"bottom-right",theme:t.theme==="dark"||t.theme==="light"?t.theme:"auto",open:t.open==="true",persist:t.persist!=="false",deepLink:t.deepLink!=="false",...Ot(t.attachments),...t.dictation==="true"?{dictation:{...t.dictationLang?{lang:t.dictationLang}:{},...t.dictationCloud==="true"?{allowCloudFallback:!0}:{}}}:{},...t.call?{call:t.callTransport==="hosted"?{endpoint:t.call,transport:"hosted"}:t.call}:{},copy:t.copy!=="false",allowDelete:t.delete==="true",...window.recourseConfig,...o?{target:o}:{}}}function Ot(e){if(!e||e==="false")return{};if(e==="true")return{attachments:!0};let t=Number(e);return Number.isFinite(t)&&t>0?{attachments:{maxBytes:Math.round(t*1024*1024)}}:{}}var Be=It();if(Be){let e=()=>{window.recourse=We(Be)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e()}})();
