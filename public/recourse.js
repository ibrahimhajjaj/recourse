"use strict";(()=>{var ht=/(\*\*[^*]+\*\*|`[^`]+`|!?\[[^\]]+\]\([^)\s]+\)|\*[^*\n]+\*)/g,bt=/^(https?:|mailto:|\/|#)/i;function ee(e){let t=document.createDocumentFragment();for(let r of vt(e))t.appendChild(xt(r));return t}function vt(e){let t=[],r=null,o=null,i=()=>{r&&r.lines.length>0&&t.push(r),r=null};for(let l of e.split(`
`)){if(/^\s*(```|~~~)/.test(l)){o?(t.push(o),o=null):(i(),o={kind:"code",lines:[]});continue}if(o){o.lines.push(l);continue}if(l.trim()===""){i();continue}let c=/^\s*[-*+]\s+(.*)$/.exec(l),s=/^\s*\d+[.)]\s+(.*)$/.exec(l),p=c?"ul":s?"ol":"p",f=c?.[1]??s?.[1]??l;(!r||r.kind!==p)&&(i(),r={kind:p,lines:[]}),r.lines.push(f)}return o&&t.push(o),i(),t}function xt(e){if(e.kind==="code"){let r=document.createElement("pre"),o=document.createElement("code");return o.textContent=e.lines.join(`
`),r.appendChild(o),r}if(e.kind==="ul"||e.kind==="ol"){let r=document.createElement(e.kind);for(let o of e.lines){let i=document.createElement("li");i.appendChild(Ne(o)),r.appendChild(i)}return r}let t=document.createElement("p");return t.appendChild(Ne(e.lines.join(" "))),t}function Ne(e){let t=document.createDocumentFragment();for(let r of e.split(ht)){if(!r)continue;if(r.startsWith("**")&&r.endsWith("**")){t.appendChild(ge("strong",r.slice(2,-2)));continue}if(r.startsWith("`")&&r.endsWith("`")){t.appendChild(ge("code",r.slice(1,-1)));continue}if(r.startsWith("*")&&r.endsWith("*")&&r.length>2){t.appendChild(ge("em",r.slice(1,-1)));continue}let o=/^!\[([^\]]*)\]\(([^)\s]+)\)$/.exec(r);if(o){let l=o[2];if(/^https:/i.test(l)){let c=document.createElement("img");c.src=l,c.alt=o[1],c.loading="lazy",c.className="md-image",t.appendChild(c)}else t.appendChild(document.createTextNode(o[1]));continue}let i=/^\[([^\]]+)\]\(([^)\s]+)\)$/.exec(r);if(i){let l=i[2];if(bt.test(l)){let c=document.createElement("a");c.textContent=i[1],c.href=l,c.target="_blank",c.rel="noopener noreferrer",t.appendChild(c)}else t.appendChild(document.createTextNode(i[1]));continue}t.appendChild(document.createTextNode(r))}return t}function ge(e,t){let r=document.createElement(e);return r.textContent=t,r}var be=/^(https?:|mailto:|tel:|\/|#)/i;function he(e,t){let r=e.showIf;if(r===void 0)return!0;if(typeof r=="boolean")return r;if(typeof r=="string"){let o=r.startsWith("!"),i=o?r.slice(1):r,[l,c]=i.split("=",2),s=t[(l??"").trim()],p=c===void 0?!!s:String(s)===c.trim();return o?!p:p}return!0}function I(e,t,r){let o=document.createElement(e);return o.textContent=t,r&&(o.className=r),o}function E(e){return typeof e=="string"?e:e==null?"":String(e)}function De(e,t,r,o=!1){if(!be.test(t))return I("span",e,r);let i=document.createElement("a");return i.textContent=e,i.href=t,o||(i.target="_blank"),i.rel="noopener noreferrer",i.className=r,i}var yt=e=>{let t=E(e.label)||"Open",r=E(e.url);if(!r)return null;let o=document.createElement("div");return o.className="ui-actions",o.appendChild(De(t,r,"ui-button",e.sameTab===!0)),o};function wt(e,t){let r=E(e.label);if(!r)return null;if(e.url)return De(r,E(e.url),"ui-button");let o=document.createElement("button");return o.type="button",o.className="ui-button",o.textContent=r,e.run?(o.addEventListener("click",async()=>{if(t.run){o.disabled=!0;try{await t.run(E(e.run),e.payload??{}),o.replaceWith(I("span",E(e.done)||"Done","ui-muted"))}catch(i){o.disabled=!1,o.textContent=i instanceof Error?i.message:"That did not work"}}}),o):(o.addEventListener("click",()=>t.submit(E(e.send)||r)),o)}var kt=(e,t)=>{let r=document.createElement("div");if(r.className="ui-card",e.image&&be.test(E(e.image))){let c=document.createElement("img");c.src=E(e.image),c.alt=E(e.title),c.loading="lazy",c.className="ui-card-image",r.appendChild(c)}let o=document.createElement("div");o.className="ui-card-body",e.title&&o.appendChild(I("h3",E(e.title))),e.subtitle&&o.appendChild(I("p",E(e.subtitle),"ui-muted"));let i=(Array.isArray(e.fields)?e.fields:[]).filter(c=>he(c,e));if(i.length>0){let c=document.createElement("dl");c.className="ui-fields";for(let s of i){let p=s;c.appendChild(I("dt",E(p.label))),c.appendChild(I("dd",E(p.value)))}o.appendChild(c)}let l=(Array.isArray(e.actions)?e.actions:[]).filter(c=>he(c,e));if(l.length>0){let c=document.createElement("div");c.className="ui-actions";for(let s of l){let p=wt(s,t);p&&c.appendChild(p)}c.childElementCount>0&&o.appendChild(c)}return r.appendChild(o),r},Ct=e=>{let t=(Array.isArray(e.columns)?e.columns:[]).map(E),r=Array.isArray(e.rows)?e.rows:[];if(t.length===0||r.length===0)return null;let o=document.createElement("div");o.className="ui-table-wrap";let i=document.createElement("table");i.className="ui-table";let l=document.createElement("thead"),c=document.createElement("tr");for(let p of t)c.appendChild(I("th",p));l.appendChild(c),i.appendChild(l);let s=document.createElement("tbody");for(let p of r.slice(0,25)){let f=document.createElement("tr"),u=Array.isArray(p)?p:t.map(b=>p[b]);for(let b of u)f.appendChild(I("td",E(b)));s.appendChild(f)}return i.appendChild(s),o.appendChild(i),o},Et=(e,t)=>{let r=(Array.isArray(e.items)?e.items:[]).filter(i=>he(i,e));if(r.length===0)return null;let o=document.createElement("div");o.className="ui-list";for(let i of r){let l=i,c=E(l.title);if(!c)continue;let s=document.createElement(l.url?"a":"button");s.className="ui-list-item",s instanceof HTMLAnchorElement&&be.test(E(l.url))?(s.href=E(l.url),s.target="_blank",s.rel="noopener noreferrer"):s instanceof HTMLButtonElement&&(s.type="button",s.addEventListener("click",()=>t.submit(E(l.send)||c))),s.appendChild(I("span",c,"ui-list-title")),l.subtitle&&s.appendChild(I("span",E(l.subtitle),"ui-muted")),o.appendChild(s)}return o.childElementCount>0?o:null};function Ie(e,t){let r=document.createElement("form");r.className="ui-form",e.title&&r.appendChild(I("h3",e.title));let o=Array.isArray(e.fields)?e.fields:[],i=[];for(let s of o){let p=s,f=E(p.name);if(!f)continue;let u=document.createElement("label");u.className="ui-field",u.appendChild(I("span",E(p.label)||f));let b;if(Array.isArray(p.options)&&p.options.length>0){let x=document.createElement("select");for(let v of p.options){let m=document.createElement("option");m.value=E(v),m.textContent=E(v),x.appendChild(m)}b=x}else if(p.type==="boolean"){let x=document.createElement("input");x.type="checkbox",b=x}else{let x=document.createElement("input");x.type=p.type==="number"?"number":"text",p.placeholder&&(x.placeholder=E(p.placeholder)),b=x}b.name=f,p.required!==!1&&b instanceof HTMLInputElement&&b.type!=="checkbox"&&(b.required=!0),u.appendChild(b),r.appendChild(u),i.push({name:f,element:b})}let l=document.createElement("button");l.type="submit",l.className="ui-button",l.textContent=e.submitLabel||"Send",r.appendChild(l);let c=!1;return r.addEventListener("submit",s=>{if(s.preventDefault(),c)return;c=!0;let p={};for(let{name:f,element:u}of i)p[f]=u instanceof HTMLInputElement&&u.type==="checkbox"?u.checked:u.value;r.replaceChildren(ee("Thanks, sending that now.")),t.respond(p)}),r}var St={button:yt,card:kt,table:Ct,list:Et};function Oe(e,t){let r=St[e.kind];return r?r(e.data,t):null}var At={offline:"Could not reach the assistant. Check your connection.",rateLimited:"Too many messages just now. Give it a moment.",unavailable:"The assistant is unavailable ({status})."};async function Fe(e,t,r,o,i=At){let l;try{l=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...t,messages:t.messages.map(f=>({role:f.role,content:f.content}))}),signal:o})}catch{r.onError?.(i.offline);return}if(!l.ok||!l.body){r.onError?.(l.status===429?i.rateLimited:i.unavailable.replace("{status}",String(l.status)));return}let c=l.body.getReader(),s=new TextDecoder,p="";for(;;){let{done:f,value:u}=await c.read();if(f)break;p+=s.decode(u,{stream:!0});let b=p.split(`

`);p=b.pop()??"";for(let x of b){let v=x.split(`
`).find(w=>w.startsWith("data:"));if(!v)continue;let m;try{m=JSON.parse(v.slice(5).trim())}catch{continue}r.onFrame?.(m),m.type==="sources"?r.onSources?.(m.sources):m.type==="delta"?r.onDelta?.(m.text):m.type==="done"?r.onDone?.():m.type==="error"&&r.onError?.(m.message)}}r.onDone?.()}function Tt(e=globalThis){let t=e;return t.SpeechRecognition??t.webkitSpeechRecognition??null}var Mt={"not-allowed":"I need permission to use the microphone. You can allow it in your browser settings.","service-not-allowed":"Your browser would not let me use speech recognition.","no-speech":"I did not hear anything. Try again?","audio-capture":"I could not find a microphone.",network:"Speech recognition needs a connection and could not reach it.","language-not-supported":"Speech recognition is not available for this language on your device."};function He(e={},t=globalThis){let r=Tt(t);if(!r)return null;let o=r,i=null,l=!1;function c(f){let u=new o;u.continuous=!0,u.interimResults=!0,u.maxAlternatives=1;let b=e.lang??Lt(t);return b&&(u.lang=b),f&&(u.processLocally=!0),u}function s(f){f.onstart=()=>e.onStateChange?.(!0),f.onresult=u=>{let b="";for(let x=u.resultIndex;x<u.results.length;x++){let v=u.results[x];if(!v)continue;let m=v[0]?.transcript??"";v.isFinal?e.onFinal?.(m):b+=m}b&&e.onInterim?.(b)},f.onerror=u=>{let b=e.processLocally!==!1,x=u.error==="language-not-supported"||u.error==="service-not-allowed";if(b&&x&&e.allowCloudFallback&&!l){l=!0,i=null,p(!1);return}u.error!=="aborted"&&e.onError?.(Mt[u.error]??"Speech recognition stopped unexpectedly.")},f.onend=()=>{i=null,e.onStateChange?.(!1)}}function p(f){let u=c(f);s(u),i=u;try{u.start()}catch{i=null,e.onStateChange?.(!1)}}return{get recording(){return i!==null},start(){i||(l=!1,p(e.processLocally!==!1))},stop(){i?.stop()},cancel(){let f=i;i=null,f?.abort(),e.onStateChange?.(!1)},toggle(){i?this.stop():this.start()}}}function Lt(e){return e.document?.documentElement?.lang??""}function Pe(e){let t=e.fetch??globalThis.fetch.bind(globalThis),r=e.load??Nt,o="idle",i=null,l=0,c=u=>{o!==u&&(o=u,e.onStateChange?.(u))},s=u=>{c("failed"),e.onError?.(u)};async function p(){if(o==="connecting"||o==="live")return;let u=++l;c("connecting");let b;try{let v=await t(e.endpoint,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({conversationId:e.conversationId()})});if(v.status===429){u===l&&s("Too many calls just now. Try again in a moment.");return}if(!v.ok){u===l&&s("Calling is not available right now.");return}let m=await v.json();if(typeof m.signedUrl!="string"||!m.signedUrl){u===l&&s("Calling is not available right now.");return}b=m.signedUrl}catch{u===l&&s("Could not reach the server to start the call.");return}if(u!==l)return;let x;try{x=await r()}catch{u===l&&s("Could not load the voice connection.");return}if(u===l)try{let v=await x.startSession({signedUrl:b,onConnect:()=>{u===l&&c("live")},onDisconnect:()=>{u===l&&(i=null,c("ended"))},onError:()=>{u===l&&s("The call ended unexpectedly. Your microphone may be blocked.")},onMessage:m=>{let w=typeof m?.message=="string"?m.message.trim():"";w&&e.onTranscript?.({role:m.source==="user"?"visitor":"agent",text:w})}});if(u!==l){await Promise.resolve(v.endSession()).catch(()=>{});return}i=v}catch{u===l&&s("Could not start the call. Your microphone may be blocked.")}}async function f(){l++;let u=i;if(i=null,u)try{await u.endSession()}catch{}c(o==="failed"?"failed":"ended")}return{get state(){return o},start:p,stop:f,async toggle(){o==="connecting"||o==="live"?await f():await p()}}}var Rt="https://cdn.jsdelivr.net/npm/@elevenlabs/client@1.23.0/+esm";async function Nt(){let t=await import(Rt);if(!t.Conversation)throw new Error("no conversation runtime in the loaded module");return t.Conversation}function ze(e,t,r=16e3){if(r>=t||e.length===0)return e;let o=t/r,i=new Float32Array(Math.floor(e.length/o));for(let l=0;l<i.length;l++){let c=Math.floor(l*o),s=Math.min(e.length,Math.floor((l+1)*o)),p=0;for(let f=c;f<s;f++)p+=e[f];i[l]=s>c?p/(s-c):0}return i}function Ue(e){let t=new Int16Array(e.length);for(let r=0;r<e.length;r++){let o=Math.max(-1,Math.min(1,e[r]));t[r]=o<0?o*32768:o*32767}return t}function We(e){if(e.length===0)return 0;let t=0;for(let r of e)t+=r*r;return Math.min(1,Math.sqrt(t/e.length)/32768)}var It=`
...
`,Ot={echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0,channelCount:1},Ft=["audio/webm;codecs=opus","audio/ogg;codecs=opus","audio/mp4"];function ve(){let e=globalThis.MediaRecorder;return e?.isTypeSupported?Ft.find(t=>e.isTypeSupported?.(t))??null:null}async function Be(e){let t=e.frameMs??20,{context:r,stream:o}=await(e.open??Pt)(),i=Math.round(r.sampleRate*t/1e3),l=r.createMediaStreamSource(o),c=URL.createObjectURL(new Blob([It],{type:"application/javascript"}));try{await r.audioWorklet.addModule(c)}finally{URL.revokeObjectURL(c)}let s=new AudioWorkletNode(r,"recourse-capture",{numberOfInputs:1,numberOfOutputs:0,processorOptions:{frameSamples:i}});s.port.onmessage=f=>{let u=ze(f.data,r.sampleRate,16e3);e.onFrame(Ue(u))},l.connect(s);let p=null;if(e.onCompressed){let f=ve();if(f){let u=!0;p=(e.record??Ht)(o,f,e.chunkMs??200,b=>{let x=u;u=!1,b.size!==0&&b.arrayBuffer().then(v=>e.onCompressed?.(v,x))})}}return{async stop(){s.port.onmessage=null,p?.stop(),l.disconnect(),s.disconnect();for(let f of o.getTracks())f.stop();await r.close()}}}function Ht(e,t,r,o){let i=new MediaRecorder(e,{mimeType:t});return i.ondataavailable=l=>o(l.data),i.start(r),{stop:()=>{try{i.state!=="inactive"&&i.stop()}catch{}}}}async function Pt(){let e=await navigator.mediaDevices.getUserMedia({audio:Ot});return{context:new AudioContext,stream:e}}function je(e){let t=e.cushionSeconds??.05,r=0;return{get endsAt(){return r},get playing(){return r>e.now()},push(o){if(o.length===0)return;let i=e.now(),l=r>i?r:i+t;e.play(o,l),r=l+o.length/e.sampleRate},clear(){r=0}}}function $e(e){let t="idle",r=null,o=null,i=null,l=null,c=0,s=m=>{t!==m&&(t=m,e.onStateChange?.(m))},p=m=>{s("failed"),e.onError?.(m)};async function f(){let m=o,w=i,M=r;o=null,i=null,l=null,r=null;try{M?.close()}catch{}await m?.stop().catch(()=>{}),w?.stop(),await w?.close().catch(()=>{})}async function u(){if(t==="connecting"||t==="live")return;let m=++c;s("connecting");let w;try{w=(e.connect??Ut)(zt(e.endpoint))}catch{m===c&&p("Could not reach the server to start the call.");return}w.binaryType="arraybuffer",r=w,w.onopen=()=>{if(m!==c){w.close();return}let M=e.compress===!1?null:ve();w.send(JSON.stringify({type:"hello",sampleRate:16e3,conversationId:e.conversationId(),...M?{audio:{mimeType:M}}:{}})),b(m,w,M)},w.onmessage=M=>{if(m===c){if(typeof M.data=="string"){let T;try{T=JSON.parse(M.data)}catch{return}T.type==="transcript"&&T.text&&T.role&&e.onTranscript?.({role:T.role,text:T.text}),T.type==="interrupted"&&(i?.stop(),l?.clear()),T.type==="error"&&e.onError?.(T.message??"Something went wrong.");return}M.data instanceof ArrayBuffer&&x(m,M.data)}},w.onerror=()=>{m===c&&(f(),p("The call was cut off."))},w.onclose=()=>{m===c&&(f(),(t==="live"||t==="connecting")&&s("ended"))}}async function b(m,w,M){try{i=(e.audio??Wt)(),l=je({now:i.now,play:i.play,sampleRate:i.sampleRate});let T=[],j=()=>{T.length===0||!xe(w)||(w.send(JSON.stringify({type:"levels",values:T,frameMs:20})),T=[])};if(o=await(e.microphone??Be)({onFrame:S=>{if(!(m!==c||!xe(w))){if(M){T.push(We(S)),T.length>=5&&j();return}w.send(S)}},...M?{onCompressed:S=>{m!==c||!xe(w)||(j(),w.send(S))}}:{}}),m!==c){await f();return}s("live")}catch{if(m!==c)return;await f(),p("Could not use your microphone. It may be blocked for this site.")}}async function x(m,w){try{let M=await i?.decode(w);if(m!==c||!M)return;l?.push(M)}catch{}}async function v(){c++,await f(),s(t==="failed"?"failed":"ended")}return{get state(){return t},start:u,stop:v,async toggle(){t==="connecting"||t==="live"?await v():await u()}}}function xe(e){return e.readyState===1||e.readyState==="open"}function zt(e){if(/^wss?:\/\//i.test(e))return e;let t=new URL(e,location.href);return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Ut(e){return new WebSocket(e)}function Wt(){let e=new AudioContext,t=[];return{sampleRate:e.sampleRate,now:()=>e.currentTime,decode:async r=>(await e.decodeAudioData(r)).getChannelData(0),play:(r,o)=>{let i=e.createBuffer(1,r.length,e.sampleRate);i.getChannelData(0).set(r);let l=e.createBufferSource();l.buffer=i,l.connect(e.destination),l.onended=()=>{t=t.filter(c=>c!==l)},l.start(o),t.push(l)},stop:()=>{for(let r of t)try{r.stop()}catch{}t=[]},close:()=>e.close()}}var _e=`
:host {
  --rc-accent: #2563eb;
